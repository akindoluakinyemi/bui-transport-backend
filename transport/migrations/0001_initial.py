    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('organizer', 'Transport Organizer'), ('admin', 'Admin')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vehicle_type', models.CharField(choices=[('cab', 'Cab'), ('sienna', 'Sienna'), ('bus', 'Bus')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transport.transportorganizer')),
            ],
        ),
        migrations.AddField(
            model_name='trip',
